...
<script>
    function search(city){
        if(city.length==0){
            ...
            var url="<%=path%>/users/searchoxygen?txt="+city;
...
<div style="padding: 10px">
    ...
    <h1 style="background-color: pink;padding:15px;text-align: center;"> Oxygen [ADD/SEARCH] </h1>
    <hr>
    <form action="<%=path%>/users/addoxygen" method="post">
