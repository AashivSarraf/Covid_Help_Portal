...
<script>
    function search(bloodGroup){
        if(bloodGroup.length==0){
            ...
            var url="<%=path%>/users/searchgroup?txt="+bloodGroup;
...
<div style="padding: 10px">
    ...
    <h1 style="background-color: pink;padding:15px;text-align: center;"> Plasma [ADD/SEARCH] </h1>
    <hr>
    <form action="<%=path%>/users/addgroup" method="post">
        ...
        <div class="row form-group">
            ...
            <div class="col-lg-6">
                ...
                <input type="text" name="bloodGroup" id="group" class="form-control" placeholder="Blood Group" required>
            </div>
        ...
        <div class="row form-group">
            ...
            <hr>
            <div align:center>
                <input style="width: 80%;margin: 30px; height: 50px;" type="text" onkeyup="search(this.value)" placeholder="Search Blood Group">
            </div>
