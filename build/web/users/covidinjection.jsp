...
<script>
    function search(injectionName){
        if(injectionName.length==0){
            ...
            var url="<%=path%>/users/searchcovidinj?txt="+injectionName;
...
<div style="padding: 10px">
    ...
    <h1 style="background-color: pink;padding:15px;text-align: center;"> Covid Injection [ADD/SEARCH] </h1>
    <hr>
    <form action="<%=path%>/users/addcovidinj" method="post">
        ...
        <div class="row form-group">
             <div class="col-lg-6">
                <label for="covidinj"><b>Injection Name</b></label>
                <input type="text" name="injectionName" id="covidinj" class="form-control" placeholder="Covid Injection Name" required>
            </div>
            <div class="col-lg-6">
