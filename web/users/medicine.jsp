...
<script>
    function search(medicineName){
        if(medicineName.length==0){
            return;
        }
        else{
            var request=new XMLHttpRequest();
            var url="<%=path%>/users/searchmedicine?txt="+medicineName;
...
<div style="padding: 10px">
    ...
    <h1 style="background-color: pink;padding:15px;text-align: center;"> Medicine [ADD/SEARCH] </h1>
    <hr>
    <form action="<%=path%>/users/addmedicine" method="post">
        ...
        <div class="row form-group">
             <div class="col-lg-6">
                <label for="covidinj"><b>Medicine Name</b></label>
                <input type="text" name="medicineName" id="covidinj" class="form-control" placeholder="Medicine Name" required>
            </div>
            <div class="col-lg-6">
        ...
        <div class="row form-group">
            ...
            <hr>
            <div align:center>
                <input style="width: 80%;margin: 30px; height: 50px;" type="text" onkeyup="search(this.value)" placeholder="Search Medicine Name">
            </div>
